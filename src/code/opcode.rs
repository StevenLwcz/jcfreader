...
impl fmt::Display for Opcode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Opcode::Ifeq(i) => write!(f, "ifeq"),
            Opcode::Ifge(i) => write!(f, "ifge"),
            Opcode::Ifgt(i) => write!(f, "ifgt"),
            Opcode::Ifle(i) => write!(f, "ifle"),
            Opcode::Iflt(i) => write!(f, "iflt"),
            Opcode::Ifne(i) => write!(f, "ifne"),
            Opcode::Ifnonnull(i) => write!(f, "ifnonnull"),
            Opcode::Ifnull(i) => write!(f, "ifnull"),
